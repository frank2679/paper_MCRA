...
We propose a Markov chain model to precisely describe the steady state behavior of the OFDMA-based random access.
Also, we analyze system efficiency and access delay of the random access mechanism. 
Finally, we estimate the effects of system parameters, including number of resource units (RUs) for random access and contension window size, on system efficiency and access delay.
\end{abstract}
